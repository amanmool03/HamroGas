  ...
  if (isset($_POST['add_order'])) {
    ...
    if(isset($_FILES['image'])){
      ...
      if(in_array($file_ext,$extensions)== false){
       $errors[]="Extension not allowed in profile, please choose a JPEG or PNG file.";
     }           

     if($file_size > 2097152){
       $errors[]='File size must be less than or equal to 2 MB in profile';
     }
   ...
   if(isset($_FILES['image1'])){
    ...
    if(in_array($file_ext1,$extensions)== false){
     $errors1[]="Extension not allowed in citizenship card, please choose a JPEG or PNG file.";
     
   }

   if($file_size1 > 2097152){
     $errors1[]='File size must be less than or equal to 2 MB in citizenship card';
